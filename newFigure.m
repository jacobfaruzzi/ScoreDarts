...
appData.numPlayers = uieditfield(appData.startPanel, 'numeric', 'Position', [380 250 200 80], 'Value', 1, 'Limits', [1 8]);

appData.minusBtn = uibutton(appData.startPanel, 'Text', '-','Position', [330 250 50 80],'ButtonPushedFcn', @(btn, event) incrementValue(appData.numPlayers, -1));

appData.plusBtn = uibutton(appData.startPanel, 'Text', '+', 'Position', [580 250 50 80], 'ButtonPushedFcn', @(btn, event) incrementValue(appData.numPlayers, 1));
